...
const FROM = process.env.EMAIL_FROM ? process.env.EMAIL_FROM : 'HIGHFIVE Tournament <onboarding@resend.dev>';
// const FROM = process.env.EMAIL_FROM ?? 'HIGHFIVE Tournament <noreply@highfive-tournament.com>';
